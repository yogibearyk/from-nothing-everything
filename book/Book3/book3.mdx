...
**The constants** — fifty specific numbers proposed as conditional derivations matching measurements across seven domains of physics, from the strength of electromagnetism (1/137.036, matched to six significant figures) to the expansion rate of the universe (pre-correction H₀ = 68.2 km/s/Mpc; post-comparison correction OP8b.5 gives 0.03σ from Planck).
...
In the **cosmology sector**, the framework faces an unresolved tension: the pre-correction Hubble constant H₀ = 68.2 km/s/Mpc differs from the Planck satellite measurement (67.36) by 15 standard deviations in the CMB acoustic-scale test. A gravitational self-potential correction (post-comparison correction OP8b.5, documented in Chapter 30) brings H₀ to 67.38 — but this correction was identified after the data mismatch, not predicted beforehand. The cosmology sector is honestly scored as **open** until the acoustic-scale tension is resolved without post-comparison adjustments.
...
But more fundamentally: the framework doesn't derive the cosmological constant by summing vacuum fluctuations at all. It derives the expansion rate H₀ directly from the tower's screening structure (Chapter 30, matching the Planck satellite to 0.03σ — post-comparison correction OP8b.5; pre-correction H₀ = 68.2) and the dark energy fraction from the tower's stage decomposition (this chapter) (post-comparison correction OP8b.5; pre-correction value: 68.2 km/s/Mpc). The cosmological constant Λ follows from these: Λ = 3H₀²Ω_Λ. The value is derived from the axioms through the screening, not through a vacuum energy sum.

No other theory proposes a specific value of the cosmological constant from structural principles alone — though the framework's derivation is conditional on the H₀ pipeline (including post-comparison correction OP8b.5), and the naturalness question remains open (see Chapter 31). The Standard Model treats it as a free parameter. String theory offers 10⁵⁰⁰ possible values (the "landscape") with no way to select among them. The framework offers one value, from zero adjustable parameters, matching observation. The "worst prediction in physics" is an artifact of the continuous approximation that does not arise in the lattice formulation — though the naturalness question (why the derived value is so small) remains open.
...
In the **particle-physics sector** (coupling constants, mass ratios, mixing angles), all testable predictions fall within 2 standard deviations of measured values, with an average pull of approximately 0.4σ. In the **cosmology sector**, the framework faces an unresolved 15σ acoustic-scale tension at the pre-correction Hubble constant H₀ = 68.2 km/s/Mpc (see Chapter 30). The post-comparison correction (OP8b.5) reduces this to 0.03σ but was identified after the data mismatch. The cosmology sector is scored separately and honestly as **open**.
...
**Cosmological parameters (Chapter 24)** — *Cosmology sector: OPEN. The joint CMB fit fails at pre-correction H₀ = 68.2 (15σ acoustic-scale tension). Post-comparison correction OP8b.5 gives H₀ = 67.38. These individual-parameter pulls are conditional on the corrected H₀. See Chapter 30.*
...
*Claim status: post-comparison correction.* The gravitational self-potential Φ was identified as a candidate correction AFTER the 1.2% discrepancy with Planck data was observed. While Φ has a structural motivation (gravity's self-coupling is a real physical effect), its inclusion was prompted by the data mismatch, not predicted beforehand. The pre-correction value (H₀ = 68.2) should be considered the framework's genuine prediction; the corrected value (H₀ = 67.38) is a post-comparison refinement. Both values are reported for transparency.
...
Adding Φ to the exponent: **H₀ goes from 68.2 to 67.38 km/s/Mpc.** Planck measures 67.36 ± 0.54. The match is 0.03σ — essentially perfect (post-comparison correction OP8b.5; pre-correction value: 68.2 km/s/Mpc).
...
But the lattice cutoff alone reduces the discrepancy by only 8 orders of magnitude (from 10¹²⁰ to 10¹¹²). The remaining 112 orders of magnitude are resolved by the framework's direct derivation of the cosmological parameters: H₀ is matching to 0.03σ (conditional on the H₀ pipeline, which includes post-comparison correction OP8b.5) from the Planck satellite value, and Ω_Λ is derived from the tower's stage decomposition (post-comparison correction OP8b.5; pre-correction value: 68.2 km/s/Mpc). The cosmological constant Λ = 3H₀²Ω_Λ follows from these derived quantities. The framework doesn't need to SUM zero-point energies — it derives Λ directly from the screening structure. The 10¹²⁰ discrepancy is avoided at the derivation level because the framework derives Λ from screening rather than summing zero-point energies. The naturalness question (why the derived value is so small) remains open — see the Scientific Status Notice.
...
action-derived; same conditional tier as Post-comparison correction OP8b.5). 
...
H₀/M_P = D^(N + Φ). Corrected H₀ = 67.38 km/s/Mpc (0.03σ from Planck) (post-comparison correction OP8b.5; pre-correction value: 68.2 km/s/Mpc).
