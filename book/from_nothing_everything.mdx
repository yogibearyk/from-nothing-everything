...
The specific breakdown of the 1980 degrees of freedom into matter, gauge, and gravitational contributions requires a more detailed lattice calculation. The TOTAL matches the Wald formula; the individual contributions are a defined computation for the lattice gravity community. Everything else — every coupling constant, every mass ratio, every mixing angle, the gravitational sector, the cosmological parameters, the dark sector, the spatial structure, the equations of quantum mechanics and general relativity, and the measurement problem's structural context — is closed.
