...
**Why the ratio φ/π and not some other combination?** The screening D must be a fraction between 0 and 1. Check every alternative: φ − π is negative; φ × π exceeds 5; φ^π exceeds 5; log_φ(π) exceeds 2. Only φ/π ≈ 0.515 and √(φ/π) ≈ 0.718 survive. Between these: the screening measures how much of one perspective cycle a single growth step covers. "Steps per cycle" is a rate, and rates are ratios (like speed = distance per time). The square root of a rate is not a rate. Therefore D = φ/π.
