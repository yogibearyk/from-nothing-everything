...
The framework doesn't replace the Standard Model's dynamics. It derives the Standard Model, whose dynamics are then automatic. Asking "can the framework compute scattering amplitudes?" is like asking "if I give you the rules of chess, can you determine all possible games?" The rules determine everything. The framework gives the rules.
