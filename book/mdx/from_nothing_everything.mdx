...
The framework is a **theory of all fundamental constants** — it derives the fifty numbers that physicists have spent a century measuring, from zero adjustable parameters, using only the golden ratio and π.
