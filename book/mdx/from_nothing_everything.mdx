...
**An open gap:** the derivation produces 3, 2, 1 from the Fibonacci decomposition but has one technical gap: reducing multiple U(1) phase factors to the single U(1) of the Standard Model. This gap is flagged honestly and does not affect the main result.
